        ...
        >
          <motion.div variants={itemVariants} className="mb-8">
            ...
            <p className="text-slate-400 text-lg leading-relaxed">
              Securely oversee your entire HRMS ecosystem. Manage subscribers, configure global billing plans, and monitor system health from a single unified dashboard.
            </p>
          </motion.div>
