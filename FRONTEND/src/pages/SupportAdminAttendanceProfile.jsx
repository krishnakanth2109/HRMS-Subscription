...
const SupportAdminAttendance = () => {
  ...
  const handleDailyStartDateChange = (newStartDate) => {
  ...
  const handleDailyEndDateChange = (newEndDate) => {
  ...
  const handleSummaryStartDateChange = (newStartDate) => {
    setSummaryStartDate(newStartDate);
    setSummaryCurrentPage(1);
    if (summaryEndDate && newStartDate > summaryEndDate) {
      setSummaryEndDate(newStartDate);
      Swal.fire({
        icon: "warning",
        title: "Invalid Date Range",
        text: "'To' date cannot be earlier than 'From' date. 'To' date updated automatically.",
  ...
  const handleSummaryEndDateChange = (newEndDate) => {
    if (summaryStartDate && newEndDate < summaryStartDate) {
      Swal.fire({
        icon: "error",
        title: "Invalid Date Range",
        text: "'To' date cannot be earlier than 'From' date.",
          ...
          <div className="p-6 border border-gray-200 shadow-sm bg-white rounded-2xl flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              ...
              <div className="w-full bg-gray-50 border border-gray-200 rounded-xl outline-none focus-within:ring-2 focus-within:ring-blue-500 focus-within:bg-white transition-all shadow-sm overflow-hidden flex items-center">
                ...
                <input type="date" value={startDate} onChange={(e) => handleDailyStartDateChange(e.target.value)} className="w-full pl-3 pr-3 py-2.5 outline-none bg-transparent text-gray-700 font-medium text-xs sm:text-sm" />
              </div>
              <div className="w-full bg-gray-50 border border-gray-200 rounded-xl outline-none focus-within:ring-2 focus-within:ring-blue-500 focus-within:bg-white transition-all shadow-sm overflow-hidden flex items-center">
                ...
                <input type="date" value={endDate} min={startDate} onChange={(e) => handleDailyEndDateChange(e.target.value)} className="w-full pl-3 pr-3 py-2.5 outline-none bg-transparent text-gray-700 font-medium text-xs sm:text-sm" />
              </div>
            </div>
          </div>
          ...
          <div className="p-6 border border-gray-200 shadow-sm bg-white rounded-2xl flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 items-end">
              ...
              <div className="w-full">
                ...
                <input type="date" value={summaryStartDate} onChange={(e) => handleSummaryStartDateChange(e.target.value)} className="px-4 py-2.5 w-full bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white shadow-sm text-sm font-medium text-gray-700" />
              </div>
              <div className="w-full">
                <label className="text-[9px] font-bold text-gray-500 uppercase tracking-wider ml-1 mb-1 block">To Date</label>
                <input type="date" value={summaryEndDate} min={summaryStartDate} onChange={(e) => handleSummaryEndDateChange(e.target.value)} className="px-4 py-2.5 w-full bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white shadow-sm text-sm font-medium text-gray-700" />
              </div>
            </div>
          </div>
