...
const EditEmployee = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name.startsWith("bankDetails.")) {
      ...
      setFormData(prev => ({ ...prev, bankDetails: { ...prev.bankDetails, [key]: cleanValue } }));
    } else if (name.startsWith("personalDetails.")) {
      const key = name.split(".")[1];
      setFormData(prev => ({ ...prev, personalDetails: { ...prev.personalDetails, [key]: cleanValue } }));
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.name.trim()) {
      setSnackbar("Full name is required");
      return;
    }

    if (formData.phone && formData.phone.length !== 10) {
      setSnackbar("Phone number must be exactly 10 digits");
      return;
    }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-1 w-full">
              ...
              <div className="relative group w-full">
                <div className="absolute left-3 top-1/2 -translate-y-1/2 transition-colors group-focus-within:text-blue-600 z-10 flex items-center pointer-events-none text-green-500">
                  <FaFileContract />
                </div>
                <select
          ...
          <form onSubmit={handlePasswordChange} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <div className="relative group w-full">
                  <div className="absolute left-3 top-1/2 -translate-y-1/2 text-red-400 group-focus-within:text-red-600 transition-colors z-10 flex items-center pointer-events-none">
                    <FaLock />
                  </div>
                  <input
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors z-10 flex items-center"
                    tabIndex={-1}
                  >
...
const InputField = ({ icon, label, className = "bg-white", ...props }) => (
  <div className="flex flex-col gap-1 w-full">
    ...
    <div className="relative group w-full">
      {icon && (
        <div className="absolute left-3 top-1/2 -translate-y-1/2 transition-colors group-focus-within:text-blue-600 z-10 flex items-center pointer-events-none">
          {icon}
        </div>
      )}
      <input
