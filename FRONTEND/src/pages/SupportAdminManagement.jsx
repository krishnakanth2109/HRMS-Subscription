...
const ALL_SIDEBAR_FEATURES = [
  ...
  { id: "/admin/field-tracking", label: "Live Tracking", category: "Management" },
  { id: "/admin/work-reports", label: "Performance Management", category: "Management" },
  ...
  { id: "/admin/holiday-calendar", label: "Holiday Calendar", category: "Management" },
  { id: "/admin/payroll", label: "Payroll", category: "Management" },
  { id: "/admin/expense", label: "Expense Management", category: "Management" },
  ...
  { id: "/admin/notices", label: "Announcements", category: "System" },
  { id: "/admin/live-tracking", label: "Idle Tracking", category: "System" },
  { id: "/admin/setup-face", label: "Settings", category: "System" },
...
const SupportAdminManagement = () => {
  ...
  const handleCreateSupportAdmin = async (event) => {
    ...
    if (newAdminForm.password !== newAdminForm.confirmPassword) {
      showSwal({ icon: "warning", title: "Passwords do not match", text: "Please re-enter the same password." });
      return;
    }
