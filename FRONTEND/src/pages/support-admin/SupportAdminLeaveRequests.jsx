            ...
            <form className="mt-4 space-y-4" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input type="date" name="to" value={form.to} min={form.from} onChange={handleChange} className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2 text-sm" required />
                </div>
              </div>
              <div>
