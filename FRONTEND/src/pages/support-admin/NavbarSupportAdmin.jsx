          ...
          <div className="relative" ref={menuRef}>
            ...
            {showMenu && (
              <div className="absolute top-12 right-0 bg-white border border-slate-200 rounded-xl shadow-2xl w-56 z-50 overflow-hidden py-1 animate-in fade-in slide-in-from-top-2">
                ...
                <button
                  onClick={() => {
                    window.open(`https://vwsync.com/portfolio/${user?.supportAdminId || user?._id || user?.adminId}`, "_blank");
                    setShowMenu(false);
                  }}
                  className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50 transition-colors"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-400"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg> 
                  View Portfolio
                </button>
