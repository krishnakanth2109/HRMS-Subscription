...
const NavbarAdminNav = ({ theme, inline = false }) => {
              ...
              >
                {section.links.filter(isRouteVisible).map((link, lIdx) => {
                  ...
                  if (childLinks.length > 0) {
                    // Group header or children container
                    return (
                      <div key={lIdx} className="space-y-1 p-1">
                        ...
                        <div className="flex flex-col gap-1">
                          {childLinks.map((child, cIdx) => {
                            ...
                            const isChildAllowed = isRouteAllowed(child);
                  ...
                  // Standard horizontal dropdown links
                  ...
                  return isAllowed ? (
                    ...
                    <button
                      ...
                      onClick={() => {
                        setActiveDropdown(null);
                        handleDisabledClick(link.label);
                      }}
