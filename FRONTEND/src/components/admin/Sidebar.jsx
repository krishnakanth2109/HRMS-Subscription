      ...
      >
        ...
        <div className={`h-16 flex items-center px-4 shrink-0 ${collapsed && !isMobile ? "justify-center" : "justify-between"}`}>
          {!collapsed || isMobile ? (
            ...
            <>
              <Link to="/admin/dashboard" className="w-11 h-11 rounded-xl bg-slate-800 ring-1 ring-slate-700/50 flex items-center justify-center text-white font-bold text-lg shrink-0 hover:bg-slate-700 transition-colors overflow-hidden shadow-md">
                <img 
